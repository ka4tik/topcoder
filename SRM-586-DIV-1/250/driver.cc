...
#include "PiecewiseLinearFunction.cc"
...
int main(int argc, char* argv[])
{
	...
	for(;;)
	{
		...
		std::cout << "# input for test " << __testnum << ": " << Y << std::endl;
		std::cout.flush();

		__timer_start();

		PiecewiseLinearFunction __object;
		int __actual = __object.maximumSolutions(Y);
